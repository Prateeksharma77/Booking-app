...
public class ItemDomain implements Serializable {
    ...
    private String tourGuidePhone; // Changed from TourGuidePhone to tourGuidePhone
    private String tourGuidePic; // Changed from TourGuidePic to tourGuidePic
    private int price;
    private int bed;
    ...
    public ItemDomain() {
        // Default constructor required for calls to DataSnapshot.getValue(ItemDomain.class)
    }
